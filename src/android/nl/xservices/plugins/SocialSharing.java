...
//         final PendingIntent pendingIntent = PendingIntent.getBroadcast(cordova.getActivity().getApplicationContext(), 0, receiverIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) { pendingIntentValueFLAG  = PendingIntent.FLAG_MUTABLE; } 
        else { pendingIntentValueFLAG  = PendingIntent.FLAG_UPDATE_CURRENT; } 
